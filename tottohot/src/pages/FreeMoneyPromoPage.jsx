...
import './FreeMoneyPromoPage.css'

const FreeMoneyPromoPage = () => {
  ...
  return (
    <PageLayout>
      <div className="free-money-promo-page">
        <div className="board-container">
        {/* 히어로 배너 */}
        <div className="hero-banner">
          <div className="hero-content">
            <h1 className="hero-title">로얄토토 꽁머니홍보</h1>
            <div className="hero-description">
              <p>각 사이트의 꽁머니 이벤트 정보를 확인하세요.</p>
              <p>홍보 게시 시 5,000포인트가 소모됩니다.</p>
            </div>
            <button className="hero-cta-btn" onClick={() => navigate('/free-money-promo/write')}>글쓰기</button>
          </div>
        </div>
        ...
        <div className="list-header">
          ...
          <div className="list-actions">
            <Link to="/free-money-promo/write" className="write-btn">
              글쓰기
            </Link>
          </div>
        </div>
        ...
        {/* 게시판 가이드 (페이지 하단) */}
        <BoardGuide boardKey="free-money-promo" />
        </div>
      </div>
    </PageLayout>
  )
...
export default FreeMoneyPromoPage
