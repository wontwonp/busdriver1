      ...
      <div className="humor-page">
        ...
        <div className="hero-banner">
          <div className="hero-content">
            <h1 className="hero-title">로얄토토 유머&이슈</h1>
            <div className="hero-description">
              <p>재미있는 유머와 최신 이슈를 공유하는 공간입니다.</p>
              <p>함께 웃고 이야기 나눠요.</p>
            </div>
            <button className="hero-cta-btn" onClick={() => navigate('/humor/write')}>글쓰기</button>
          </div>
        </div>
        ...
        <div className="list-header">
          ...
          <div className="list-actions">
            <Link to="/humor/write" className="write-btn">
              글쓰기
            </Link>
          </div>
        </div>
